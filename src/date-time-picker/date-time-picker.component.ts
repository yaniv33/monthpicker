// import {Component, OnInit, Input, forwardRef, ViewChild, AfterViewInit, Injector, Injectable} from '@angular/core';
...
//         let str : string = '';
//         if ($event.year){
//             str = `${$event.year}-${$event.month}-${$event.day}`
//         }
//
//         const date = DateTimeModel.fromLocalString(str);
//
//         if (!date) {
